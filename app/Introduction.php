<?php
//remember to activate apache on xampp
//don't close the php unless you have to ?>

<?= 'these are the echo tags <?= ... ?>' ?>
<?php echo 'these are the echo tags <?= ... ?>' ; ?>
...
$x = 4; //int
$y = 4.5; //float
$txt = 'Text $x times'; //string literal
echo $txt;
$txt = "Text $x times"; //string that gets parsed
echo $txt;
